...
const Contact = () => {
    ...
    const socialLinks = [
        ...
        {
            href: 'https://www.facebook.com/naextro',
            icon: <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M13.5 3C9.63401 3 6.5 6.13401 6.5 10C6.5 13.866 9.63401 17 13.5 17H14V21H16.5V17H18V14.5H16.5V13C16.5 12.4477 16.9477 12 17.5 12H18.5V9.5H17.5C15.8431 9.5 14.5 10.8431 14.5 12.5V14.5H13.5V10C13.5 6.68629 10.8137 4 7.5 4C4.18629 4 1.5 6.68629 1.5 10C1.5 13.3137 4.18629 16 7.5 16H8V14H7.5C5.567 14 4 12.433 4 10.5C4 8.567 5.567 7 7.5 7C9.433 7 11 8.567 11 10.5C11 12.433 9.433 14 7.5 14H6.5V16H8V17H6.5V18.5H8V21H10.5V18.5H12V17H10.5V16H13.5C17.366 16 20.5 12.866 20.5 9C20.5 5.13401 17.366 2 13.5 2V3Z" fill="currentColor" />
            </svg>,
            alt: 'Facebook'
        },
        ...
        <section id='contact' className="section">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    <h2 className="headline-2 lg:max-w-[12ch]">Let’s Collaborate</h2>
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">Have an idea or a project in mind? Reach out and let’s build something amazing together.</p>
                    ...
                    <form action="https://getform.io/f/axoylqpb" method='POST' className="xl:pl-10">
                        <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                            <div className="mb-4">
                                ...
                                <input type="text" name='name' id='name' autoComplete='name' required placeholder='Ibne Arif Al Riham' className="text-field" />
                            </div>
                            <div className="mb-4 ">
                                <label htmlFor="email" className="label">
                                    Email
                                </label>
                                <input type="email" name='email' id='email' autoComplete='email' required placeholder='ibnereham@gmail.com' className="text-field" />
                            </div>
                        </div>
                        <div className="mb-4">
                            <label htmlFor="message" className="label">Message
                            </label>
                            <textarea name="message" className='text-field resize-y min-h-32 max-h-80' placeholder='Wassup' id="message"></textarea>
                        </div>
